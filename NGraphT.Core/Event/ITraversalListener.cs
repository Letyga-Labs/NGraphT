...
public interface ITraversalListener<TNode, TEdge>
{
    /// <summary>
    ...
    void VertexTraversed(VertexTraversalEventArgs<TNode> e);
    ...
    /// </summary>
    /// <param name="e"> the vertex traversal event. </param>
    void VertexFinished(VertexTraversalEventArgs<TNode> e);
}
