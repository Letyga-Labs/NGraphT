...
public sealed class WeightedPseudograph<TVertex, TEdge> : Pseudograph<TVertex, TEdge>
    where TVertex : class
    where TEdge : class
{
    /// <summary>
    ...
    public WeightedPseudograph(Func<TVertex>? vertexSupplier, Func<TEdge>? edgeSupplier)
