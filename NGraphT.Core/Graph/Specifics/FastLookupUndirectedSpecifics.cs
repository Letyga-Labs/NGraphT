...
/// A disadvantage is an increase in memory consumption.
/// If memory utilization is an issue, use a <see cref="UndirectedSpecifics{TVertex,TEdge}"/> instead.
/// </summary>
///
...
public class FastLookupUndirectedSpecifics<TVertex, TEdge> : UndirectedSpecifics<TVertex, TEdge>
    where TVertex : class
    where TEdge : class
{
    /// <summary>
    ...
    public FastLookupUndirectedSpecifics(
        ...
        IDictionary<UnorderedPair<TVertex, TVertex>, ISet<TEdge>>     touchingVerticesToEdgeMap,
    ...
    /// </summary>
    protected IDictionary<UnorderedPair<TVertex, TVertex>, ISet<TEdge>> TouchingVerticesToEdgeMap { get; init; }
    ...
    public override ISet<TEdge> GetAllEdges(TVertex? sourceVertex, TVertex? targetVertex)
    {
        ...
        var vertexPair = new UnorderedPair<TVertex, TVertex>(sourceVertex, targetVertex);
        if (!TouchingVerticesToEdgeMap.TryGetValue(vertexPair, out var edges))
        {
            return ImmutableHashSet<TEdge>.Empty;
        }
