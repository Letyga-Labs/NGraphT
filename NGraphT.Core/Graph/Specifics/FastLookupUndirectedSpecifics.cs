...
/// containsEdge(TNode u, TNode TNode), addEdge(TNode u, TNode TNode). A disadvantage is an increase in memory consumption.
/// If memory utilization is an issue, use a <seealso cref="UndirectedSpecifics"/> instead.
/// </summary>
///
...
public class FastLookupUndirectedSpecifics<TNode, TEdge> : UndirectedSpecifics<TNode, TEdge>
{
    /// <summary>
    ...
    public override ISet<TEdge> GetAllEdges(TNode sourceVertex, TNode targetVertex)
    {
        ...
        {
            ISet<TEdge> edges = TouchingVerticesToEdgeMap[new UnorderedPair<TEdge>(sourceVertex, targetVertex)];
            if (edges == null)
            {
