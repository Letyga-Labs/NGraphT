...
public class Multigraph<TVertex, TEdge> : AbstractBaseGraph<TVertex, TEdge>
    where TVertex : class
    where TEdge : class
{
    /// <summary>
    ...
    public Multigraph(Func<TVertex>? vertexSupplier, Func<TEdge>? edgeSupplier, bool weighted)
        : base(
            vertexSupplier,
            edgeSupplier,
