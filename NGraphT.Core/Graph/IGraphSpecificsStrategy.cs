...
///
/// <seealso cref="FastLookupGraphSpecificsStrategy{TNode,TEdge}"/>
/// <seealso cref="DefaultGraphSpecificsStrategy{TNode,TEdge}"/>
///
    ...
    where TEdge : class
{
    ...
    Func<IGraphType, IIntrusiveEdgesSpecifics<TNode, TEdge>> IntrusiveEdgesSpecificsFactory { get; }
    ...
    IEdgeSetFactory<TNode, TEdge> EdgeSetFactory => new ArrayUnenforcedSetEdgeSetFactory<TNode, TEdge>();
}
