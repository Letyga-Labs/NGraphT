...
public class AsUnweightedGraph<TNode, TEdge> : GraphDelegator<TNode, TEdge>, IGraph<TNode, TEdge>
{
    ...
    {
        throw new NotSupportedException(EdgeWeightIsNotSupported);
    }
