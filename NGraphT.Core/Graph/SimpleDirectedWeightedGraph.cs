...
public sealed class SimpleDirectedWeightedGraph<TVertex, TEdge> : SimpleDirectedGraph<TVertex, TEdge>
    where TVertex : class
    where TEdge : class
{
    /// <summary>
    ...
    public SimpleDirectedWeightedGraph(Func<TVertex>? vertexSupplier, Func<TEdge>? edgeSupplier)
