...
///
/// <seealso cref="DefaultUndirectedGraph{TVertex,TEdge}"/>
public class DefaultUndirectedWeightedGraph<TVertex, TEdge> : DefaultUndirectedGraph<TVertex, TEdge>
    where TVertex : class
    where TEdge : class
{
    /// <summary>
    ...
    public DefaultUndirectedWeightedGraph(Func<TVertex>? vertexSupplier, Func<TEdge>? edgeSupplier)
