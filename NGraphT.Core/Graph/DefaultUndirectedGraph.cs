...
public class DefaultUndirectedGraph<TVertex, TEdge> : AbstractBaseGraph<TVertex, TEdge>
    where TVertex : class
    where TEdge : class
{
    /// <summary>
    ...
    public DefaultUndirectedGraph(Func<TVertex>? vertexSupplier, Func<TEdge>? edgeSupplier, bool weighted)
