...
public sealed class WeightedMultigraph<TVertex, TEdge> : Multigraph<TVertex, TEdge>
    where TVertex : class
    where TEdge : class
{
    /// <summary>
    ...
    public WeightedMultigraph(Func<TVertex>? vertexSupplier, Func<TEdge>? edgeSupplier)
