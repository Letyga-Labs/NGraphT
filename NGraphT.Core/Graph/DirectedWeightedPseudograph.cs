...
public sealed class DirectedWeightedPseudograph<TVertex, TEdge> : DirectedPseudograph<TVertex, TEdge>
    where TVertex : class
    where TEdge : class
{
    /// <summary>
    ...
    public DirectedWeightedPseudograph(Func<TVertex>? vertexSupplier, Func<TEdge>? edgeSupplier)
