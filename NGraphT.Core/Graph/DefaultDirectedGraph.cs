...
public class DefaultDirectedGraph<TVertex, TEdge> : AbstractBaseGraph<TVertex, TEdge>
    where TVertex : class
    where TEdge : class
{
    /// <summary>
    ...
    public DefaultDirectedGraph(Func<TVertex>? vertexSupplier, Func<TEdge>? edgeSupplier, bool weighted)
