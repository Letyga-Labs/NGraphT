...
public class DefaultDirectedGraph<TNode, TEdge> : AbstractBaseGraph<TNode, TEdge>
{
    ...
    public DefaultDirectedGraph(Func<TNode> vertexSupplier, Func<TEdge> edgeSupplier, bool weighted)
        : base(vertexSupplier,
            edgeSupplier,
            (new DefaultGraphType.Builder()).Directed().AllowMultipleEdges(false).AllowSelfLoops(true)
...
//ORIGINAL LINE: public static <TNode, TEdge> GraphBuilder<TNode, TEdge, ? extends DefaultDirectedGraph<TNode, TEdge>> createBuilder(Class edgeClass)
    public static GraphBuilder<TNode, TEdge, DefaultDirectedGraph<TNode, TEdge>> CreateBuilder<TNode, TEdge>(
        Type edgeClass
    )
    {
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in C#:
//ORIGINAL LINE: return new GraphBuilder<>(new DefaultDirectedGraph<>(edgeClass));
        return new GraphBuilder<TNode, TEdge, DefaultDirectedGraph<TNode, TEdge>>(
            new DefaultDirectedGraph<TNode, TEdge, DefaultDirectedGraph<TNode, TEdge>>(edgeClass)
        );
    }
...
//ORIGINAL LINE: public static <TNode, TEdge> GraphBuilder<TNode, TEdge, ? extends DefaultDirectedGraph<TNode, TEdge>> createBuilder(Supplier<TEdge> edgeSupplier)
    ...
    {
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in C#:
//ORIGINAL LINE: return new GraphBuilder<>(new DefaultDirectedGraph<>(null, edgeSupplier, false));
        return new GraphBuilder<TNode, TEdge, DefaultDirectedGraph<TNode, TEdge>>(
            new DefaultDirectedGraph<TNode, TEdge, DefaultDirectedGraph<TNode, TEdge>>(null, edgeSupplier, false)
        );
    }
}
