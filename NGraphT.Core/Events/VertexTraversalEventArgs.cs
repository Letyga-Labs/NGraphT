...
public class VertexTraversalEventArgs<TVertex> : EventArgs
{
    /// <summary>
    ...
    public VertexTraversalEventArgs(object eventSource, TVertex vertex)
    {
        Vertex = vertex;
    }
    ...
    /// </summary>
    public virtual TVertex Vertex { get; protected set; }
}
