...
public static class CollectionUtil
{
    ...
    /// it can hold without rehashing. See <see cref="NewHashMapWithExpectedSize{TKey,TNode}"/> for details.
    /// </para>
    /// </summary>
    ///
    ...
    /// See <see cref="NewHashMapWithExpectedSize{TKey,TNode}(int)"/> for details.
    /// </para>
    /// </summary>
    ///
