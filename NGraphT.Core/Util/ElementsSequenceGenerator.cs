...
public class ElementsSequenceGenerator<T> : IEnumerator<T>, IEnumerable<T>
{
    /// <summary>
    ...
    /// <summary>
    /// Constructs a new <seealso cref="ElementsSequenceGenerator"/>.
    /// </summary>
    ...
    /// <summary>
    /// Constructs a new <seealso cref="ElementsSequenceGenerator"/> using the specified {@code seed}. Two
    ...
    public ElementsSequenceGenerator(ICollection<T> elements, long seed)
        : this(elements, new Random(seed))
    {
    }

    /// <summary>
    /// Constructs a new <seealso cref="ElementsSequenceGenerator"/> using the specified random number
